...
local pcall, tostring, type, require, loadstring, io_stderr, io_write, io_read, table_insert, table_concat, table_pack, table_unpack, print =
       pcall, tostring, type, require, loadstring, io.stderr, io.write, io.read, table.insert, table.concat, table.pack, unpack, print
...
-- patches to stop triggering strict.lua
local _PROMPT = nil
local _PROMPT2 = nil
